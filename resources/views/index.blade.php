    ...
    <div class="container overflow-hidden">
      <div class="row gy-3 gy-lg-0 align-items-lg-center justify-content-lg-between">
        ...
        <div class="col-12 col-lg-5 text-center">
          <img class="img-fluid" loading="lazy" src="./images/aisha.png" style="transform: scale(1.2)" alt="" style="-webkit-mask-image: url(./assets/img/hero/hero-blob-1.svg); mask-image: url(./assets/img/hero/hero-blob-1.svg);">
        </div>
      </div>
    </div>
  </section>
